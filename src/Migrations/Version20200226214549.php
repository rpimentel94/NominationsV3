 ...
 */
final class Version20200226214549 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE election_cycles DROP date_created, DROP deleted, CHANGE date_start date_start INT NOT NULL, CHANGE date_end date_end INT NOT NULL, CHANGE active active TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE election_cycles ADD date_created BIGINT NOT NULL, ADD deleted TINYINT(1) DEFAULT \'0\' NOT NULL, CHANGE date_start date_start BIGINT DEFAULT NULL, CHANGE date_end date_end BIGINT DEFAULT NULL, CHANGE active active TINYINT(1) DEFAULT \'1\' NOT NULL');
    }
}
